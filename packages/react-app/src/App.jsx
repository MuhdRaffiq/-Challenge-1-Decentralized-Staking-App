...
import "./App.css";
import { Row, Col, Button, Menu, Alert, List, InputNumber } from "antd";
...
function App(props) {
  ...
  let completeDisplay = (
    <div style={{ padding: 30, backgroundColor: "#FFA07A", fontWeight: "bolder", border: '5px solid rgba(0, 0, 0, 0.05)' }}>
      <h3>No external contract has been called</h3>
    </div>
  )
  if (complete) {
    completeDisplay = (
      <div style={{ padding: 30, backgroundColor: "#eeffef", fontWeight: "bolder", border: '5px solid rgba(0, 0, 0, 0.05)' }}>
  ...
  */
    ...
    networkDisplay = (
      <div style={{ zIndex: 2, position: 'absolute', right: 0, top: 60, padding: 16 }}>
        <Alert
          ...
          description={(
            <div>
              You have <b>{NETWORK(selectedChainId)}</b> selected and you need to be on <b>{NETWORK(localChainId).name}</b>.
            </div>
          )}
          type="error"
          closable={false}
  ...
  function onChange(value) {
    ...
    console.log("data input:", typeof(newInput));
    console.log("custom eth:", newInput)
  }
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div>
              <h1>Challenge 1: Staking Mechanism</h1>
            </div>
            

            {completeDisplay}

            <div style={{ padding: 30, display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gridGap: 20 }}>
            ...
            <div style={{ padding: 10, backgroundColor: "#bfbfbf", fontWeight: "bolder", border: '5px solid rgba(0, 0, 0, 0.05)' }}>
              ...
              <div style={{ padding: 8 }}>
                <InputNumber style={{width: 200,}} defaultValue="1" min="0" max="5" step="0.1" onChange={onChange} stringMode/>
                <Button type={balanceStaked ? "success" : "primary"} onClick={() => {
                tx(writeContracts.Staker.stake({ value: parseEther(newInput) }))
                }}>Stake custom ether!</Button>
              </div>
            ...
            <div style={{ padding: 30, display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gridGap: 20 }}>
              ...
              <div style={{ padding: 8  }}>
                <h3>Execute when threshold reached</h3>
              ...
              <div style={{ padding: 8 }}>
                <h3>Withdraw before threshold reached</h3>
                <Button type={"default"} onClick={() => {
